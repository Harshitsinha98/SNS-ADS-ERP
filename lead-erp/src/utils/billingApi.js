...
export const getAdLeadIntegrationStatus = (orgId) => authedGet(`/api/ad-leads/status?orgId=${encodeURIComponent(orgId)}`);
export const createGoogleAdsLeadIntegration = (body) => authedPost("/api/ad-leads/google", body);
export const listMetaLeadPages = (body) => authedPost("/api/ad-leads/meta/pages", body);
export const connectMetaLeadPage = (body) => authedPost("/api/ad-leads/meta/connect", body);
export const disconnectMetaLeadPage = (body) => authedPost("/api/ad-leads/meta/disconnect", body);
export const scheduleFollowUpTask = (body) => authedPost("/api/follow-ups/schedule", body);
export const completeFollowUpTask = (taskId, body) => authedPost(`/api/follow-ups/${encodeURIComponent(taskId)}/complete`, body);
export const updateFollowUpLeadStatus = (leadId, body) => authedPost(`/api/follow-ups/${encodeURIComponent(leadId)}/status`, body);
export const reassignFollowUpLead = (leadId, body) => authedPost(`/api/follow-ups/${encodeURIComponent(leadId)}/reassign`, body);
